...
import { Stake, ChooseBond, Bond, Dashboard, TreasuryDashboard, PoolTogether, Presale, Claim } from "./views";
...
import "./style.scss";
import { bhd_dai } from "./helpers/AllBonds";
...
//  console.log("1111",bonds)
  ...
  useEffect(() => {
    ...
    if (shouldTriggerSafetyCheck()) {
      dispatch(info("Safety Check: Always verify you're on HOMdao.app!"));
    }
  }, []);
