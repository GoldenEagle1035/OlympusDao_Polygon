...
export class NodeHelper {
   ...
   */
  static getNodesUris = () => {
    let allURIs = ["https://speedy-nodes-nyc.moralis.io/20143f1b569c2c0eb495ebdb/polygon/mainnet/archive"];
//https://speedy-nodes-nyc.moralis.io/a3fdf311d3d82a9d4be805d3/bsc/mainnet
    return allURIs;
  };

  static getTestNodeUris = () => {
    let allURIs = ["https://speedy-nodes-nyc.moralis.io/20143f1b569c2c0eb495ebdb/polygon/testnet/"];
